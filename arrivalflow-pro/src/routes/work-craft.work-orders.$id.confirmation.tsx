...
import { OPERATORS } from "@work/lib/ams/mock-data";
import { mandatoryChecksPassed, useAms } from "@work/lib/ams/store";

export const Route = createFileRoute("/work-craft/work-orders/$id/confirmation")({
