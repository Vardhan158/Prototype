    ...
    <div className="grid gap-4 lg:grid-cols-3">
      <div className="surface-card p-6 lg:col-span-2">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          <Link to="/work-craft/work-orders/$id/edit" params={{ id }}>
            <Button variant="outline">Edit</Button>
          </Link>
          <Link to="/work-craft/work-orders">
          ...
          {woCerts.length === 0 ? (
            ...
            woCerts.map((c) => (
              <div key={c.certificateNumber} className="mt-3 flex items-center justify-between">
                ...
                <Link to="/work-craft/certificates/$number" params={{ number: c.certificateNumber }}>
