...
import { INSPECTORS } from "@work/lib/ams/mock-data";
import { useAms } from "@work/lib/ams/store";
import type { CheckpointResult } from "@work/lib/ams/types";

export const Route = createFileRoute("/work-craft/work-orders/$id/quality")({
