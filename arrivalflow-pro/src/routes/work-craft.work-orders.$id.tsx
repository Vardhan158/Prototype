...
export const Route = createFileRoute("/work-craft/work-orders/$id")({
  head: () => ({
    meta: [
...
const TABS = [
  { to: "/work-craft/work-orders/$id", label: "Details" },
  { to: "/work-craft/work-orders/$id/bom", label: "BOM Details" },
  { to: "/work-craft/work-orders/$id/consumption", label: "Component Consumption" },
  { to: "/work-craft/work-orders/$id/stages", label: "Assembly Progress" },
  { to: "/work-craft/work-orders/$id/quality", label: "Quality Checkpoints" },
  { to: "/work-craft/work-orders/$id/confirmation", label: "Assembly Confirmation" },
] as const;
