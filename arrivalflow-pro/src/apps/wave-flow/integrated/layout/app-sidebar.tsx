...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    key: "pick-lists",
    label: "Pick Lists",
    to: "/wave-flow/pick-lists",
    icon: ClipboardList,
    group: "Warehouse Execution",
  },
  {
    key: "picking",
    label: "Picking",
    to: "/wave-flow/picking",
    icon: Warehouse,
    group: "Warehouse Execution",
  },
  {
  ...
  },
  {
    key: "staging",
    label: "Staging",
    to: "/wave-flow/staging",
    icon: ClipboardCheck,
    group: "Outbound Logistics",
  },
  {
    key: "loading",
    label: "Loading & Shipment",
    to: "/wave-flow/loading",
    icon: Truck,
    group: "Outbound Logistics",
  },
  {
    key: "load-verification",
    label: "Load Verification",
    to: "/wave-flow/load-verification",
    icon: ShieldCheck,
    group: "Outbound Logistics",
  },
  {
      ...
      <nav className="h-[calc(100vh-3.5rem)] overflow-y-auto px-3 py-4">
          ...
          <div key={group} className="mb-4">
            ...
            <ul className="space-y-0.5">
              {items
                ...
                .map((item) => {
                  const isActive =
                    item.to === "/" ? pathname === "/wave-flow" : pathname.startsWith(item.to);
                  return (
                    <li key={item.key}>
                      <Link
                        to={item.to}
        ...
        <div className="rounded-md border border-dashed border-border p-3">
          <p className="text-[11px] leading-relaxed text-muted-foreground">
            Other WMS modules (Receiving, Inventory, Returns, Master Data) mount alongside this
            module in the enterprise shell.
          </p>
        </div>
      </nav>
    </aside>
