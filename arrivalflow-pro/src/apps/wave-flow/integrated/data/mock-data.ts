...
export const products: Product[] = [
  {
    sku: "SKU-48120",
    name: 'LED Panel Light 40W 2x2"',
    uom: "EA",
    category: "Electrical",
    barcode: "8901234481203",
    weightKg: 2.4,
  },
  {
    sku: "SKU-48221",
    name: "Industrial Hex Bolt M12 (100pk)",
    uom: "BOX",
    category: "Fasteners",
    barcode: "8901234482217",
    weightKg: 5.1,
  },
  {
    sku: "SKU-49330",
    name: "Nitrile Gloves Large (Case)",
    uom: "CS",
    category: "Safety",
    barcode: "8901234493307",
    weightKg: 3.8,
  },
  {
    sku: "SKU-50110",
    ...
    barcode: "8901234501106",
    weightKg: 0.6,
  },
  {
    sku: "SKU-51044",
    name: "Stainless Steel Shelf 900mm",
    uom: "EA",
    category: "Fixtures",
    barcode: "8901234510449",
    weightKg: 12.5,
  },
  {
    sku: "SKU-52781",
  ...
  },
  {
    ...
    uom: "BDL",
    category: "Packaging",
    barcode: "8901234539026",
    weightKg: 7.0,
  },
  {
    sku: "SKU-54118",
    name: "Hydraulic Hose 3/8in 2m",
    uom: "EA",
    category: "Hydraulics",
    barcode: "8901234541180",
    weightKg: 1.9,
  },
  {
    sku: "SKU-55420",
    name: "Vitamin C Tablets 500mg (Case)",
    uom: "CS",
    category: "Pharma",
    barcode: "8901234554205",
    weightKg: 6.3,
  },
  {
    sku: "SKU-56033",
    name: "Automotive Oil Filter A/12",
    uom: "EA",
    category: "Automotive",
...
export const warehouses: Warehouse[] = [
  {
    code: "WH-CHI-01",
    name: "Chicago Central DC",
    city: "Chicago",
    zones: ["Zone A", "Zone B", "Zone C", "Cold Zone"],
  },
  {
    code: "WH-DAL-02",
    name: "Dallas Regional DC",
    city: "Dallas",
    zones: ["Zone A", "Zone B", "Bulk Zone"],
  },
  {
    code: "WH-NJ-03",
    name: "New Jersey Hub",
    city: "Newark",
    zones: ["Zone A", "Zone D", "High Bay"],
  },
];
...
const orderSeed: Array<
  [string, string, Priority, SalesOrder["status"], SalesOrder["validation"], string, string, string]
> = [
  [
    "SO-2026-4101",
...
export const pickLines: PickLine[] = Array.from({ length: 18 }, (_, i) => {
  ...
  return {
    ...
    verified: state === 2,
    status:
      state === 0 ? "Pending" : state === 1 ? "In Progress" : state === 3 ? "Short" : "Picked",
  } satisfies PickLine;
});
...
export const packingRecords: PackingRecord[] = [
  {
    ...
    material: "Double-wall + bubble wrap",
    labelNumber: "LBL-99120",
  ...
  },
  {
    ...
    carton: "PLT-EUR-1",
    weightKg: 220.0,
    dimensions: "120 x 80 x 145 cm",
    material: "Stretch wrap + corner boards",
    labelNumber: "LBL-99121",
  ...
  },
  {
    ...
    material: "Single-wall + void fill",
    labelNumber: "LBL-99122",
  ...
  },
  {
    ...
    carton: "TOTE-STD-B",
    weightKg: 6.8,
    dimensions: "60 x 40 x 32 cm",
    material: "Reusable tote + lid seal",
    labelNumber: "LBL-99123",
    station: "Pack Station 2",
    operator: "C. Reyes",
    status: "Pending",
  },
  {
    ...
    material: "Insulated crate + gel packs",
    labelNumber: "LBL-99124",
    station: "Cold Pack Bay",
    operator: "D. Sorensen",
    status: "Completed",
  },
  {
    ...
    carton: "PLT-US-2",
    weightKg: 310.0,
    dimensions: "122 x 102 x 160 cm",
    material: "Stretch wrap",
    labelNumber: "LBL-99125",
    station: "Pack Station 1",
    operator: "N. Ibrahim",
    status: "Pending",
  },
...
export const shipments: Shipment[] = [
  {
    ...
    container: "CNT-88120",
    seal: "SEAL-441209",
    scheduledAt: "2026-07-31 09:00",
    destination: "Chicago, IL",
    trackingNo: "FX-772199310",
    loadVerified: true,
    dispatch: "Dispatched",
    status: "In Transit",
  },
  {
    ...
    container: "CNT-88121",
    seal: "SEAL-441210",
    scheduledAt: "2026-07-31 11:30",
    destination: "Boston, MA",
    trackingNo: "DH-559120044",
    loadVerified: true,
    dispatch: "Approved",
  ...
  },
  {
    ...
    container: "CNT-88122",
    seal: "SEAL-441211",
    scheduledAt: "2026-07-31 13:15",
    destination: "Austin, TX",
    trackingNo: "FX-772199344",
    loadVerified: false,
  ...
  {
    id: "SH-30414",
    orders: ["SO-2026-4109", "SO-2026-4120"],
    carrier: "XPO Logistics",
    vehicle: "VH-4411",
    driver: "Dana Whitfield",
    dock: "Dock 02",
    container: "CNT-88123",
    seal: "SEAL-441212",
    scheduledAt: "2026-07-31 15:45",
    destination: "Dallas, TX",
    trackingNo: "XP-330128877",
    loadVerified: false,
    dispatch: "Awaiting Dispatch",
    status: "Staged",
  },
  {
    ...
    container: "CNT-88124",
    seal: "SEAL-441213",
    scheduledAt: "2026-08-01 08:00",
    destination: "Detroit, MI",
    trackingNo: "UP-100238841",
    loadVerified: false,
    dispatch: "Rejected",
    status: "Staged",
  },
...
export const backorders: Backorder[] = [
  {
    id: "BO-5501",
    order: "SO-2026-4108",
    customer: "Sierra Foods Wholesale",
    sku: "SKU-50110",
    product: "Thermal Printer Ribbon 110mm",
    missingQty: 120,
    availableQty: 45,
    suggested: 45,
    reason: "Insufficient stock at allocation",
  ...
  },
  {
    ...
    sku: "SKU-56033",
    product: "Automotive Oil Filter A/12",
    missingQty: 60,
    availableQty: 60,
    suggested: 60,
    reason: "Reserved by higher priority wave",
  ...
  },
  {
    id: "BO-5503",
    order: "SO-2026-4105",
    customer: "Helix Electronics Ltd.",
    sku: "SKU-48120",
    product: 'LED Panel Light 40W 2x2"',
    missingQty: 35,
    availableQty: 0,
    suggested: 0,
  ...
  },
  {
    ...
    customer: "Meridian Auto Parts",
    sku: "SKU-54118",
    product: "Hydraulic Hose 3/8in 2m",
    missingQty: 18,
    availableQty: 210,
    suggested: 18,
...
export const notifications: NotificationItem[] = [
  {
    id: "NT-1",
    title: "Wave released",
    message: "WV-2026-0231 released with 3 orders and 42 lines.",
    time: "8 min ago",
    severity: "success",
    read: false,
  },
  {
    ...
    message: "BO-5501 raised for SO-2026-4108 — 120 units short.",
    time: "1 hr ago",
    severity: "danger",
    read: false,
  },
  {
    ...
    message: "SH-30412 approved by Warehouse Manager.",
    time: "1 hr ago",
    severity: "success",
    read: false,
  },
  {
    ...
    message: "Wave WV-2026-0232 picking in progress (Zone B).",
    time: "2 hrs ago",
    severity: "info",
    read: true,
  },
  {
    ...
    message: "WV-2026-0233 cannot be released — inventory not reserved.",
    time: "3 hrs ago",
    severity: "warning",
    read: true,
  },
  {
    ...
    message: "SH-30411 departed Dock 01 at 09:12.",
    time: "5 hrs ago",
    severity: "info",
    read: true,
  },
