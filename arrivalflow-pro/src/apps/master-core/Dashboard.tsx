...
const stats = [
  { label: "Total Suppliers", value: "1,284", delta: "+3.2%", icon: Truck, to: "/master-core/suppliers" },
  { label: "Total Customers", value: "902", delta: "+1.8%", icon: Users, to: "/master-core/customers" },
  { label: "Total Items", value: "18,447", delta: "+6.4%", icon: Package, to: "/master-core/items" },
  { label: "Warehouses", value: "24", delta: "+2", icon: WarehouseIcon, to: "/master-core/warehouses" },
  { label: "Employees", value: "3,118", delta: "+0.9%", icon: IdCard, to: "/master-core/employees" },
  { label: "Vehicles", value: "486", delta: "+12", icon: Boxes, to: "/master-core/vehicles" },
  { label: "Countries", value: "42", delta: "+1", icon: Globe2, to: "/master-core/geography" },
] as const;

const quickActions = [
  { label: "Create Supplier", to: "/master-core/suppliers", icon: Truck },
  { label: "Create Customer", to: "/master-core/customers", icon: Users },
  { label: "Create Item", to: "/master-core/items", icon: Package },
  { label: "Create Warehouse", to: "/master-core/warehouses", icon: WarehouseIcon },
] as const;
...
export function Dashboard() {
  return (
    <div className="min-h-full">
      <PageHeader
        crumbs={[{ label: "Master Data Management", to: "/master-core" }, { label: "Dashboard" }]}
        ...
        <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
          {stats.map((s) => (
            <Link
              key={s.label}
              to={s.to}
              className="group rounded-2xl border border-border bg-card p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-lg"
            >
