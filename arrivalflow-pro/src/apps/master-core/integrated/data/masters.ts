...
export const suppliers: Supplier[] = [
  [
    "SUP-1001",
    "Nordwerk Präzision GmbH",
    "Manufacturer",
    "Anke Brandt",
    "+49 211 884 2210",
    "a.brandt@nordwerk.de",
    "nordwerk.de",
    "Industriestrasse 44",
    "Düsseldorf",
    "NRW",
  ...
  [
    "SUP-1002",
    "Sanko Polymer Industries",
    "Manufacturer",
    "Hiroshi Tanaka",
    "+81 6 6210 3388",
    "tanaka@sankopolymer.jp",
    "sankopolymer.jp",
    "2-14 Nishi-Honmachi",
    "Osaka",
    "Osaka",
  ...
  [
    "SUP-1003",
    "Vertex Steel & Alloys Pvt Ltd",
    "Distributor",
    "Rakesh Menon",
    "+91 22 4988 1120",
    "rakesh@vertexsteel.in",
    "vertexsteel.in",
    "Plot 21, MIDC Taloja",
    "Navi Mumbai",
    "Maharashtra",
  ...
  [
    "SUP-1005",
    "Lumière Électronique SAS",
    "Manufacturer",
    "Camille Robert",
    "+33 4 72 11 90 44",
    "c.robert@lumiere-e.fr",
    "lumiere-e.fr",
    "18 Rue de la Villette",
    "Lyon",
    "Auvergne",
    "France",
    "69003",
  ...
  [
    ...
    "Lucía Ferreyra",
    "+54 11 4302 8890",
    "lucia@pampasrubber.ar",
    "pampasrubber.ar",
    "Av. Amancio Alcorta 2300",
    "Buenos Aires",
    "CABA",
    "Argentina",
    "C1283",
  ...
  [
    "SUP-1009",
    "Maple Ridge Tooling Inc.",
    "Manufacturer",
    "Daniel Rousseau",
    "+1 514 555 0188",
    "d.rousseau@mapleridge.ca",
    "mapleridge.ca",
    "880 Boul. Industriel",
    "Montréal",
    "Quebec",
  ...
  [
    "SUP-1010",
    "Sahara Packaging FZE",
    "Distributor",
    "Yusuf Al-Amin",
    "+971 4 883 2210",
    "yusuf@saharapack.ae",
    "saharapack.ae",
    "Jebel Ali Free Zone S3",
    "Dubai",
    "Dubai",
    "UAE",
    "17000",
  ...
  [
    "SUP-1012",
    "Cape Metalcraft (Pty) Ltd",
    "Manufacturer",
    "Thabo Nkosi",
    "+27 21 447 9902",
    "thabo@capemetal.co.za",
    "capemetal.co.za",
    "5 Voortrekker Rd",
    "Cape Town",
    "Western Cape",
  ...
  (r, i) =>
    ({
      ...
      gstNumber: r[12],
      taxNumber: r[13],
      certification: r[14] as Supplier["certification"],
      certificationExpiry: r[15],
      commodities: (r[16] as string).split(";"),
      paymentTerms: r[17],
      currency: r[18],
      bank: r[19],
      status: r[20] as Status,
...
export const customers: Customer[] = [
  [
    "CUS-2001",
    "Helios Automotive Group",
    "Marta Ríos",
    "+34 93 220 4411",
    "m.rios@heliosauto.es",
    "Carrer de Tarragona 84, Barcelona",
    "Pol. Ind. Zona Franca, Barcelona",
    "Sea Freight",
    "Net 45",
    "EUR",
    "ESB12345678",
  ...
  [
    "CUS-2002",
    "Northline Appliances Inc.",
    "Kyle Brennan",
    "+1 312 555 0107",
    "kbrennan@northline.com",
    "220 W Monroe St, Chicago",
    "4400 Distribution Dr, Joliet",
    "LTL Road",
    "Net 30",
    "USD",
    "US-27-4488192",
  ...
  [
    "CUS-2003",
    "Kanto Mobility Systems",
    "Aiko Nakamura",
    "+81 3 5422 7788",
    "aiko@kantomobility.jp",
    "1-8 Shibaura, Tokyo",
    "Kawasaki Logistics Park",
    "Air Freight",
    "Net 30",
    "JPY",
    "JP7010001098765",
  ...
  [
    "CUS-2005",
    "Meridian Healthcare Supplies",
    "Elena Kovač",
    "+386 1 428 9911",
    "elena@meridianhc.si",
    "Dunajska cesta 160, Ljubljana",
    "Logistični Center Brnik",
  ...
  [
    "CUS-2006",
    "Cascade Outdoor Retail",
    "Hannah Whitmore",
    "+1 503 555 0139",
    "hannah@cascadeoutdoor.com",
  ...
  [
    "CUS-2007",
    "Emirates Facility Solutions",
    "Nadia Haddad",
    "+971 2 665 3300",
    "nadia@emfacility.ae",
    "Corniche Rd, Abu Dhabi",
    "Mussafah Industrial M-14",
    "Road Container",
    "Net 45",
    "AED",
    "AE100999888700003",
  ...
  [
    "CUS-2008",
    "Southern Cross Mining Ltd",
    "Peter Callaghan",
    "+61 8 9322 4411",
    "peter@scmining.com.au",
    "110 St Georges Tce, Perth",
  ...
  [
    "CUS-2010",
    "Andes Agro Cooperativa",
    "Rodrigo Salas",
    "+56 2 2887 4400",
    "rsalas@andesagro.cl",
    "Av. Apoquindo 4500, Santiago",
    "Rancagua Acopio Norte",
    "Temperature Controlled",
    "Net 45",
    "USD",
    "CL76.221.884-9",
  ...
  (r, i) =>
    ({
      ...
      billingAddress: r[5],
      shippingAddress: r[6],
      deliveryLocations: (i % 5) + 1,
      shipmentPreference: r[7],
      paymentTerms: r[8],
      currency: r[9],
      taxNumber: r[10],
      country: r[11],
      priority: r[12] as Customer["priority"],
      category: r[13],
...
export const items: Item[] = [
  [
    "ITM-3001",
    "Cold Rolled Steel Coil 1.2mm",
    "CRCA coil, 1250mm width, commercial quality",
    "Raw Material",
    "Steel",
    "KG",
    "4850 kg",
  ...
  [
    ...
    "Sealed radial bearing, C3 clearance",
    "Component",
    "Bearings",
    "EA",
    "0.13 kg",
  ...
  [
    "ITM-3003",
    "Wire Harness Assembly WH-220",
    "Main cabin harness, 22 circuits",
    "Sub Assembly",
    "Electrical",
    "EA",
    "1.90 kg",
  ...
  [
    "ITM-3004",
    "Industrial Gearbox GX-40 Finished",
    "Assembled and tested helical gearbox",
    "Finished Goods",
    "Drives",
    "EA",
    "62 kg",
  ...
  [
    "ITM-3005",
    "Epoxy Primer EP-500 (20L)",
    "Two-component anti-corrosive primer",
    "Raw Material",
    "Chemicals",
    "L",
    "22 kg",
  ...
  [
    "ITM-3006",
    "Nitrile Gasket Ring 120mm",
    "Oil-resistant NBR gasket",
    "Component",
    "Sealing",
    "EA",
    "0.04 kg",
  ...
  [
    "ITM-3007",
    "PCB Control Board CB-9",
    "4-layer motor control board",
    "Sub Assembly",
    "Electronics",
    "EA",
    "0.22 kg",
  ...
  [
    "ITM-3008",
    "Aluminium Extrusion 40×40 T-Slot",
    "6063-T5 anodised profile, 6m bar",
    "Raw Material",
    "Aluminium",
    "M",
    "1.6 kg/m",
  ...
  [
    "ITM-3009",
    "Hydraulic Power Pack HP-12 Finished",
    "12L reservoir, 3kW motor, tested",
    "Finished Goods",
    "Hydraulics",
    "EA",
    "94 kg",
  ...
  [
    "ITM-3010",
    "Stainless Fastener Kit M8",
    "A2-70 bolts, nuts, washers (100 sets)",
    "Component",
    "Fasteners",
    "BOX",
    "3.2 kg",
  ...
  [
    "ITM-3011",
    "Cryo Transport Pouch CT-2",
    "Insulated pouch for cold chain shipping",
    "Finished Goods",
    "Packaging",
    "EA",
    "0.6 kg",
  ...
  [
    "ITM-3012",
    "Engineering Plastic Granule PA66",
    "Glass-filled polyamide, natural",
    "Raw Material",
    "Polymers",
    "KG",
    "25 kg/bag",
  ...
  (r, i) =>
    ({
      ...
      minStock: Number(r[14]),
      maxStock: Number(r[15]),
      reorderLevel: Number(r[16]),
      shelfLife: r[17],
      hazard: r[18],
      storage: r[19],
      hsnCode: r[20],
...
export const warehouses: Warehouse[] = [
  ...
  (r, i) =>
    ({
      ...
      manager: r[3],
      capacity: Number(r[4]),
      utilization: Number(r[5]),
      status: r[6] as Status,
...
export const carriers: Carrier[] = [
  ...
  (r, i) =>
    ({
      ...
      phone: r[3],
      email: r[4],
      refrigerated: r[5] === "true",
      hazardTransport: r[6] === "true",
      licenseNumber: r[7],
...
export const recentActivity = [
  {
    ...
    target: "Nordwerk Präzision GmbH",
    type: "Supplier",
    time: "8 minutes ago",
  },
  {
    actor: "Farah Siddiqui",
    action: "updated payment terms for",
    target: "Sahara Packaging FZE",
    type: "Supplier",
    time: "42 minutes ago",
  },
  {
    actor: "Kenji Sato",
    action: "activated item",
    target: "PCB Control Board CB-9",
    type: "Item",
    time: "2 hours ago",
  },
  {
    actor: "Bram de Vries",
    action: "added bin range to",
    target: "WH-01 Rack R03",
    type: "Warehouse",
    time: "5 hours ago",
  },
  {
  ...
  {
    actor: "Chloé Martin",
    action: "revised exchange rate for",
    target: "BRL — Brazilian Real",
    type: "Country",
